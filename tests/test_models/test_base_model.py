...
class Test_BaseModel(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertTrue(
            ('id' and 'created_at' and 'updated_at'
             and 'name' and '__class__' and 'number')
            in self.test_args.keys()
            )
        ...
        self.assertEqual(datetime.isoformat(
            created_at_datetime), self.test_args['created_at'])
    ...
    def test_reinstantiation(self):
        ...
        self.assertEqual(datetime.fromisoformat(
            test_args['created_at']), self.model2.created_at)
